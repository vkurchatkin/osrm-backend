                         ...
                         std::vector<NodeID> &leg_packed_path) const
    {
        ...
        if (super::facade->GetCoreSize() > 0)
        {
            ...
            super::SearchWithCore(forward_heap, reverse_heap, forward_core_heap, reverse_core_heap,
                                  new_total_weight, leg_packed_path, needs_loop_forwad,
                                  needs_loop_backwards);
        }
        else
        {
            super::Search(forward_heap, reverse_heap, new_total_weight, leg_packed_path,
        ...
        if (search_to_forward_node)
        {
            ...
            if (super::facade->GetCoreSize() > 0)
            {
                ...
                super::SearchWithCore(
                    ...
                    new_total_weight_to_forward, leg_packed_path_forward,
                    super::NeedsLoopForward(source_phantom, target_phantom), DO_NOT_FORCE_LOOP);
            }
            else
            {
                super::Search(forward_heap, reverse_heap, new_total_weight_to_forward,
        ...
        if (search_to_reverse_node)
        {
            ...
            if (super::facade->GetCoreSize() > 0)
            {
                ...
                super::SearchWithCore(forward_heap, reverse_heap, forward_core_heap,
                                      reverse_core_heap, new_total_weight_to_reverse,
                                      leg_packed_path_reverse, DO_NOT_FORCE_LOOP,
                                      super::NeedsLoopBackwards(source_phantom, target_phantom));
            }
            else
            {
                super::Search(forward_heap, reverse_heap, new_total_weight_to_reverse,
                              leg_packed_path_reverse, DO_NOT_FORCE_LOOP,
                              super::NeedsLoopBackwards(source_phantom, target_phantom));
            }
        }
                    ...
                    InternalRouteResult &raw_route_data) const
    {
            ...
            if (search_to_reverse_node || search_to_forward_node)
            {
                if (allow_uturn_at_waypoint)
                {
                    SearchWithUTurn(forward_heap, reverse_heap, forward_core_heap,
                                    ...
                                    new_total_weight_to_forward, packed_leg_to_forward);
                ...
                else
                {
                    Search(forward_heap, reverse_heap, forward_core_heap, reverse_core_heap,
                           ...
                           target_phantom, total_weight_to_forward, total_weight_to_reverse,
                           new_total_weight_to_forward, new_total_weight_to_reverse,
        ...
        if (total_weight_to_forward > total_weight_to_reverse)
        {
            ...
            UnpackLegs(phantom_nodes_vector, total_packed_path_to_reverse,
                       packed_leg_to_reverse_begin, total_weight_to_reverse, raw_route_data);
        }
        else
        {
            // insert sentinel
            ...
            UnpackLegs(phantom_nodes_vector, total_packed_path_to_forward,
                       packed_leg_to_forward_begin, total_weight_to_forward, raw_route_data);
        }
    }
};
}
