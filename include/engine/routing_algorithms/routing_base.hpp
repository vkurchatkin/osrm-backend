    ...
    */
                ...
                const int duration_upper_bound = INVALID_EDGE_WEIGHT) const
    {
        ...
        while (0 < (forward_heap.Size() + reverse_heap.Size()))
        {
            ...
            {
                RoutingStep(forward_heap, reverse_heap, middle, weight, min_edge_offset, true,
                            STALLING_ENABLED, force_loop_forward, force_loop_reverse);
            }
            if (!reverse_heap.Empty())
            {
                RoutingStep(reverse_heap, forward_heap, middle, weight, min_edge_offset, false,
                        ...
                        int duration_upper_bound = INVALID_EDGE_WEIGHT) const
    {
        ...
        while (0 < (forward_heap.Size() + reverse_heap.Size()))
        {
            ...
            if (!reverse_heap.Empty())
            {
                ...
                {
                    RoutingStep(reverse_heap, forward_heap, middle, weight, min_edge_offset,
        ...
        {
            RoutingStep(forward_core_heap, reverse_core_heap, middle, weight,
                        min_core_edge_offset, true, STALLING_DISABLED, force_loop_forward,
                        force_loop_reverse);

            RoutingStep(reverse_core_heap, forward_core_heap, middle, weight,
